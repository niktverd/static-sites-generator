...
function curl_query(){
	...
	$phone=$_POST['phone'];
    $data = array(
        "api_key" => "a76d3ed58edf23770a857c1c26a6f72cd3f865e9",
        "offer_id" => "104",
        "goal_id" => "312",
		"payout" => "30",
		"affiliate_id" => "255",
    ...
    $url = "https://monadvert.scaletrk.com/api/v2/affiliate/leads?api-key=a76d3ed58edf23770a857c1c26a6f72cd3f865e9"; //API接口
